...
Groundskeeper.prototype.clean = function (data) {
    ...
    var source = falafel(data, {
        comment: true,
        tolerant: true
    }, function (node) {

        if (this.options.namespace) {
            this.removeNamespace(node, this.options.namespace.split('.'));
        }
    ...
    return this.removePragmas(program.comments, source.toString(), this.options.pragmas);
        ...
        ranges = comments
            .map(function (comment) {
                if (
                    ...
                    (pragmas.length && pragmas.indexOf(comment.value.replace(pragmaMatcher, '$1')) === -1)
